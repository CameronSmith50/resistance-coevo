...
# Save directory
saveDir = './data/paper_data/figure2_201_final/'
...
if runData:
    ...
    for yInd, y in tqdm(enumerate(resistance_vector), total=len(resistance_vector)):
        ...
        for c1Ind, c1 in enumerate(c1_vector):
            ...
            optAlphaP = fsolve(lambda alphaP: findAlphaP(alphaP, y, c1, ode_parameters), x0=0.6)
...
ax1.set_yticklabels(['1', '1.2'], fontsize = fSize)
...
ax2.set_yticklabels(['1', '1.5'], fontsize = fSize)
