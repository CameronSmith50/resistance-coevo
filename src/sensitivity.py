...
def generateData(n = 25, save = False):
    ...
    dfcols = ['b', 'alphaD', 'betaD', 'betaP', 'gammaD', 'gammaP', 'y',
...
def plotData(savedir, save=False):
    ...
    figHeight = 40
    fsize = 32
    fig1, axs1 = plt.subplots(nrows=3, ncols=3, figsize=(figWidth, figHeight),
                                sharey=True)
    fig2, axs2 = plt.subplots(nrows=3, ncols=3, figsize=(figWidth, figHeight),
                                sharey=True)
    fig3, axs3 = plt.subplots(nrows=3, ncols=3, figsize=(figWidth, figHeight),
                                sharey=True)
